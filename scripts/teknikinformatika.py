...
import os
import time
from helperti import save_to_csv  # Impor fungsi save_to_csv dari helperti

# Konfigurasi logging
os.makedirs("logs", exist_ok=True)
logging.basicConfig(
    filename="logs/scraping_ti.log",
    level=logging.INFO,
    format="%(asctime)s - %(levelname)s - %(message)s"
)

# URL target
BASE_URL = "file:///c:/Users/asus/Downloads/WebScrapingSinta/scripts/daftarkampus.html"
# BASE_URL = "https://campus.quipper.com/directory?study_field=Ilmu%20Komputer"
...
def scrape_data():
    ...
    try:
        ...
        while True:
            ...
            for kampus_element in kampus_elements:
                ...
                if nama_kampus_element:
                    ...
                    kampus_list.append([nama_kampus, "Teknik Informatika"])
        ...
        if kampus_list:
            save_to_csv(kampus_list, "data/daftar_kampus_ti.csv")
            logging.info(f"Data berhasil disimpan di data/daftar_kampus_ti.csv")
        else:
